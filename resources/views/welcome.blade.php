...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 space-y-16">
    <section class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="space-y-6">
            ...
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-semibold text-[#0f1b2b] leading-tight">HappyTek — Easily Solved.</h1>
            <p class="text-lg text-[#2b3f54]">We fix the everyday tech that slows people down. From low tech energy households to founders and small teams, HappyTek keeps devices, accounts, and setups working without back-and-forth.</p>
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="/contact" class="btn-primary">Get it fixed</a>
                <a href="/pricing" class="btn-secondary">See pricing</a>
            </div>
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2 text-sm text-[#2b3f54]">
                <div class="card-surface p-4">
                    <p class="font-semibold text-[#0f1b2b]">Handled quickly</p>
                    <p class="mt-1">Remote, secure help with clear next steps.</p>
                </div>
                <div class="card-surface p-4">
                    <p class="font-semibold text-[#0f1b2b]">For low tech energy</p>
                    <p class="mt-1">Plain language that respects any comfort level.</p>
                </div>
                <div class="card-surface p-4">
                    <p class="font-semibold text-[#0f1b2b]">For founders & teams</p>
        ...
        <div class="card-surface border-[#d9e8d2] shadow-lg p-8 space-y-6">
            <div class="flex items-start gap-3">
                <div class="h-12 w-12 rounded-full bg-gradient-to-br from-[#6eb43f] to-[#1f65d1] text-white flex items-center justify-center font-semibold shadow-md">HT</div>
                <div>
                    <p class="text-lg font-semibold text-[#0f1b2b]">Your tech, finished properly</p>
                    <p class="text-sm text-[#2b3f54]">Scheduling, support, and follow-through in one place. We keep you posted and only access what you approve.</p>
                </div>
            </div>
