...
Route::post('/requests/{request}/payment-intent', [RequestController::class, 'paymentIntent'])
    ->name('requests.payment-intent');
Route::post('/requests/{request}/confirm-payment', [RequestController::class, 'confirmPayment'])
